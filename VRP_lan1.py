...
vehicle_capacity = int(input("Nhập tải trọng tối đa của xe (tấn): "))
...
# 4. Vẽ lộ trình
# ----------------------------
# hàm lộ trình xe chạy qua các điểm, trong đó điểm 0 là kho, các điểm còn lại là khách hàng
def plot_route(locs,route):
    ...
    plt.scatter(x[0],y[0],c='red',s=120,label="Kho") # kho với tọa độ (0,0)
